...
public:
	...
	{
        string::iterator buf = (string::iterator)_buffer;
		return string::iterator(buf);
	}

	string ::iterator end ()
	{
        string::iterator buf = (string::iterator)(_buffer + _parseLength);
		return string::iterator(buf);
	}
	...
	long find ( char srchChar, long offset, long length = -1 )
	{
        ...
        string::iterator start = (string::iterator)(_buffer + offset);
        string::iterator end   = (string::iterator)(_buffer + (offset + length));
	...
	long find ( char * srchStr, long offset, long length = -1 )
	{
        ...
        string::iterator srchStart = (string::iterator)srchStr;
        string::iterator srchEnd   = (string::iterator)(srchStr + strlen(srchStr));
